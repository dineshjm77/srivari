        ...
        <div class="page-content">
            <div class="container-fluid">
                    ...
                    <div class="col">
                        ...
                        <div class="d-flex align-items-center gap-2 mt-1">
                            <small class="text-muted">
                                Application: <?php echo htmlspecialchars($member['agreement_number']); ?> |
                ...
                <div class="alert alert-info d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h6 class="mb-1">Seat Number: <strong><?php echo htmlspecialchars($site_number); ?></strong></h6>
                        <p class="mb-0">EMI #<?php echo ($highlight_emi_index + 1); ?> is highlighted below as it corresponds to seat number <?php echo htmlspecialchars($site_number); ?></p>
                    </div>
                </div>
                <?php endif; ?>
                                ...
                                <?php if (!empty($site_number)): ?>
                                    <div class="mt-2">
                                        <span class="badge bg-info">
                                            <i class="fas fa-map-marker-alt"></i> Seat: <?php echo htmlspecialchars($site_number); ?>
                                        </span>
                                    </div>
                                <?php endif; ?>
                            </div>
